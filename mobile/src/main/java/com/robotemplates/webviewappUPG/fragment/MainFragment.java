package com.robotemplates.webviewappUPG.fragment;
...
import com.robotemplates.webviewappUPG.WebViewAppConfig;
import com.robotemplates.webviewappUPG.ads.AdMobUtility;
import com.robotemplates.webviewappUPG.js.JavaScriptAPI;
import com.robotemplates.webviewappUPG.listener.DrawerStateListener;
import com.robotemplates.webviewappUPG.listener.LoadUrlListener;
import com.robotemplates.webviewappUPG.listener.WebViewOnKeyListener;
import com.robotemplates.webviewappUPG.listener.WebViewOnTouchListener;
import com.robotemplates.webviewappUPG.utility.DownloadFileUtility;
import com.robotemplates.webviewappUPG.utility.IntentUtility;
import com.robotemplates.webviewappUPG.view.PullToRefreshMode;
import com.robotemplates.webviewappUPG.R;
import com.robotemplates.webviewappUPG.utility.PermissionRationaleHandler;
import com.robotemplates.webviewappUPG.utility.Preferences;
...
public class MainFragment extends TaskFragment implements SwipeRefreshLayout.OnRefreshListener, AdvancedWebView.Listener {
	...
	private void handleUploadPermissionsResult(PermissionManager.PermissionsResult permissionsResult) {
		...
		if (permissionsResult.isGranted()) {
			...
			if (mStoredActivityResultIntent != null) {
				...
				// restart fragment after image capture permissions are granted because upload form is stuck for some reason
				restartFragment();
			}
		}
	}
	...
	private void restartFragment() {
		String url = mWebView.getUrl();
		if (url == null || url.equals("")) url = mUrl;
		Fragment fragment = MainFragment.newInstance(url, mShare);
